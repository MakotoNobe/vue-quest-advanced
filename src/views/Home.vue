<template>
    <div class="home">
        <v-sheet tile height="54" class="d-flex">
            ...
            <v-btn color="primary" fab dense small class="ma-2" @click="switchCreateTaskDialog(true)">
        ...
        <v-sheet height="600">
            <v-calendar ref="calendar" v-model="value" :type="type" :events="events" :event-overlap-threshold="30" @click:event="toEventPage"></v-calendar>
        </v-sheet>
    </div>
</template>
