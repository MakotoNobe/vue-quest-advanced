<template>
  <div>
    <v-dailog v-model="CreateTaskDialog" persinstent max-width="600px">
      <v-card>
          <v-card-title>
      ...
      <v-container>
        ...
        <v-menu close-on-content-click :nudge-width="200" offset-x>  
          ...
          <v-sheet elevation="10" rounded="xl">
            <div class="pa-4">
              <v-chip-group v-model="selctColorNo" mandatory column>
                <v-chip
...
export default {
    ...
    methods:{
      ...
      createEvent(){
        const payload = {
          eventNo : this.$store.state.event.events.lenght +1,
          name: this.eventName,
